...
REVOKE ALL ON FUNCTION public.purchase_voucher(uuid, integer) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.purchase_voucher(uuid, integer) TO authenticated;
