...
{"raw_text": string|null, "provider_name": string|null, "reference": string|null, "amount_php": number|null, "fee_php": number|null, "sender_number": string|null, "sender_name": string|null, "sender_account_masked": string|null, "receiving_number": string|null, "receiving_name": string|null, "receiving_account_masked": string|null, "transfer_method": string|null, "status": string|null, "paid_at": string|null, "readable": boolean, "confidence": number}
...
- "sender_number" is the mobile number the money was sent FROM; "receiving_number" is the mobile or account number it was sent TO. Copy digits exactly, including masked characters as printed.
