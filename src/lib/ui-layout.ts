...
const SLOT_SOURCE: SlotSource[] = [
  ...
  { name: "settings.gcash-notification-listener", label: "Payment notification listener", group: "Settings", roles: ["super_admin"] },
  { name: "settings.gcash-notification-listener-2", label: "Payment notification listener", group: "Settings", roles: ["super_admin"] },
