  ...
  return (
    <>
      <EarningsHistory
        ...
        description="Credits generated by this shop (newly issued credits — not wallet-to-wallet transfers) plus every reseller and subreseller earning, derived from finalized records. Filter by period, type, product, status or member."
        highlightTypes={["credit_generation", "sale_cashback", "upline_commission"]}
      />
