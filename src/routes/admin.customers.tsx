                ...
                >
                  {detail.role === "reseller"
                    ...
                    : detail.role === "subreseller"
                      ? `Subreseller · ${detail.reseller_discount_percent}% discount · ${detail.sale_commission_percent ?? defaultSubSaleCommission}% credit-back${detail.sale_commission_percent === null ? " (shop default)" : ""} · no credit-loading commission`
                      : "Customer"}
                </StatusBadge>
