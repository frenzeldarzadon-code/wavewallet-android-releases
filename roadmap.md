...
- [ ] Payment listener redesign: listener devices capture ALL supported payment notifications (no per-account pairing); receipt vs notification ≥2 independent matches; duplicate-credited receipt → disapproved; blurry/mismatch → manual review; Super Admin UI wording; tests
